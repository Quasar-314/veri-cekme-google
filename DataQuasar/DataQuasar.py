...
class LoginDialog(QDialog):
    ...
    def check_remembered(self):
        try:
            with open("remember.txt", "rb") as f:  # Dosyayı ikili modda aç
    ...
    def check_code(self):
        ...
        if code in VALID_CODES:
            ...
            with open("remember.txt", "wb") as f:  # Dosyayı ikili modda aç
...
class ExcelViewer(QWidget):
    ...
    def load_country_data(self):
        try:
            with open('ulke.json', 'r', encoding='utf-8') as file:
    ...
    def save_country_data(self):
        try:
            with open('ulke.json', 'w', encoding='utf-8') as file:
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Set window icon before other setup
        window_icon = QIcon("path/to/your/window_icon.png")  # Replace with your icon path
        ...
        logo_label = QLabel()
        logo_pixmap = QPixmap("icon/DataQuasar.png")  # Replace with your logo path
        ...
        title_layout.addStretch()  # Pushes subsequent widgets to the right
        
        # Create help button with text
        self.help_button = QPushButton("Destek")
    ...
    def open_help(self):
        help_url = "https://www.instagram.com/3.14quasar/"
        webbrowser.open(help_url)  # Yardım bağlantısını açıyoruz
